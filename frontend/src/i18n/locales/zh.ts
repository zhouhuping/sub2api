export default {
  ...
  admin: {
    ...
    settings: {
      ...
      customMenu: {
        title: '自定义菜单页面',
        description: '添加自定义页面到侧边栏导航。每个页面可以设置为普通用户或管理员可见，并选择内嵌或新标签页打开。',
        itemLabel: '菜单项 #{n}',
        name: '菜单名称',
