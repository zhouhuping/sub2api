export default {
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Norvo',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Norvo AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🎁 Redeem access permissions</li><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      redeemMenu: {
      ...
      redeemSubmit: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the redeem button to apply the code to your account.</p><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>🚀 After redeeming:</b><br/>Your balance, concurrency, subscription, or trial permissions will be updated automatically.</p></div>'
      },
      keyManage: {
